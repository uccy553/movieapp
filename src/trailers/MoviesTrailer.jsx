...
const TrailerTvShows = ({ moviesTitle, movieData, setTrailer }) => {
        ...
        <div className='trailer-container'>
            ...
            <AiOutlineClose fontSize={30} className={!videoUrl && showError ? 'close-btn1' : 'close-btn'} color="#fff" cursor="pointer" onClick={() => setTrailer(true)} />
             ...
             {movieData.filter(movie => movie.title === moviesTitle).map(filteredMovie => (
                <div id={filteredMovie.id} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
